"""
Employee page object for Trackora application.
"""

from pages.base_page import BasePage
from utils.locators import EmployeePageLocators
...
class EmployeePage(BasePage):
    ...
    def click_add_employees_button(self):
        """Click Add Employees button"""
        self.click_element(self.locators.ADD_EMPLOYEES_BUTTON)
    ...
    def navigate_to_department_tab(self):
        """Navigate to Department tab"""
        self.click_element(self.locators.DEPARTMENT_TAB)
    
    def navigate_to_employee_tab(self):
